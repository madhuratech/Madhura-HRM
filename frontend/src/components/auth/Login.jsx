...
import { User, Lock, ArrowRight, ShieldCheck, Briefcase, TrendingUp, Wrench, Loader2 } from 'lucide-react';
        ...
        <div className="md:w-1/2 p-12 bg-white flex flex-col justify-center">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-70 text-white font-bold py-3 rounded-xl shadow-lg shadow-blue-600/20 transition-all flex items-center justify-center gap-2">
              {loading ? <><Loader2 className="animate-spin" size={18} /> Signing in...</> : <>Sign In to Dashboard <ArrowRight size={18} /></>}
            </button>
          </form>
