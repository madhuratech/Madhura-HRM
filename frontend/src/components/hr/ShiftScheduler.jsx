...
import { Clock, Users, ChevronLeft, ChevronRight, CheckCircle, XCircle, ArrowRightLeft, Loader2 } from 'lucide-react';
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse min-w-[1000px]">
                ...
                <tbody className="divide-y divide-slate-100">
                  {loading ? (
                    <tr><td colSpan={weekDays.length + 1} className="p-8 text-center"><Loader2 className="animate-spin text-blue-500 mx-auto" size={32} /></td></tr>
