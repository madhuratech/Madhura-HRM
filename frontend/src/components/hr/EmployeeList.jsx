...
import { Mail, Phone, MapPin, Search, Plus, Clock, Loader2 } from 'lucide-react';
              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="pt-2 border-t border-slate-50 mt-2">
                   <div className="flex items-center justify-between">
                     ...
                     <div className={`flex items-center gap-1.5 px-2 py-1 rounded text-xs font-bold border ${getTodayShift(employee._id || employee.employeeId || '1').color}`}>
                       <Clock size={12} />
                       {getTodayShift(employee._id || employee.employeeId || '1').label}
                     </div>
                   </div>
                </div>
              </div>
