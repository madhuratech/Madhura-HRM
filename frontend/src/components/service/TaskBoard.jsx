...
import { MoreHorizontal, Plus, Filter, Clock, Loader2 } from 'lucide-react';
              ...
              <div
                ...
                className="bg-white p-4 rounded-lg shadow-sm border border-slate-100 hover:shadow-md transition-shadow cursor-pointer group">
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <span className="text-xs font-bold text-slate-400">#JOB-{task._id.slice(-6).toUpperCase()}</span>
