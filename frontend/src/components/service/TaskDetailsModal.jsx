        ...
        <div className="bg-slate-50 px-6 py-4 border-b border-slate-200 flex justify-between items-center sticky top-0">
          <div>
            <div className="flex items-center gap-3 mb-1">
              <span className="text-sm font-bold text-slate-500">JOB-{(task._id || '123456').slice(-6).toUpperCase()}</span>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <div className="w-6 h-6 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-xs font-bold">
                        {task.assignedTo ? (task.assignedTo.name || task.assignedTo).substring(0, 2).toUpperCase() : 'U'}
                      </div>
                      <p className="text-sm font-bold text-slate-700">
                        {task.assignedTo === 'unassigned' || !task.assignedTo ? 'Unassigned' : 'Assigned Tech'}
                      </p>
                    </div>
                  </div>
                  <div>
